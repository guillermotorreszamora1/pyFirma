# COPYRIGHT Guillermo Torres Zamora 2020 MIT LICENSE.
# with code copied from  endesive  Copyright (c) 2018 Grzegorz Makarewicz
...
def check_signature(pdf_stream):
    root_cert = x509.load_pem_x509_certificate(open('/usr/share/pyfirma/cert.pem').read().encode(),backend=default_backend())
